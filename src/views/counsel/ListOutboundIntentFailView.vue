    ...
    <vuescroll>
      ...
      <div class="pagination-group">
        ...
        <v-pagination
          ...
          @input="getOutboundIntentFailList"
          :total-visible="10"
        ></v-pagination>
      </div>
...
export default {
  ...
  computed: {
    ...
    optionSync: {
      ...
      set: function (options) {
        ...
        if (doit) {
          this.getOutboundIntentFailList()
        }
      }
    }
  },
  ...
  methods: {
    async initIntentFailView () {
      await this.getOutboundIntentFailSearchCondition()
      this.getOutboundIntentFailList()
    },
    getOutboundIntentFailSearchCondition: function () {
      getOutboundIntentFailSearchCondition().then(
        response => {
    ...
    getOutboundIntentFailList: function () {
      /* datepicker open */
      ...
      getOutboundIntentFailList(searchCondition).then(
        response => {
    ...
    excelDown: function () {
      ...
      reqExcelDownOutboundIntentFail(searchCondition).then(response => {
        const filename = this.$moment().format('YYYY-MM-DD') + '_O/B_의도추론_실패_현황.xlsx'
