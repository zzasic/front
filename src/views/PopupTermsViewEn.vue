      ...
      <div class="layer-terms">
        <v-container>
          ...
          <v-row class="mb-3">
            <v-col></v-col>
            <v-col cols="2">
              <span class="label">Select revision date</span>
            </v-col>
            <v-col cols="4">
            <v-select
        ...
        <vuescroll>
          <div class="text">
            ...
            <p>Last updated: September 09, 2020</p>
            ...
            <ul>
              ...
              <li>
                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to LG CNS, 71, Magokjungang 8-ro, Gangseo-gu, Seoul, Republic of Korea.</p>
              </li>
              <li>
              ...
              <li>
                <p><strong>Website</strong> refers to LG CNS AI Service Portla, accessible from <a href="http://ai.lgstation.com" rel="external nofollow noopener" target="_blank">http://ai.lgstation.com</a></p>
              </li>
              <li>
            ...
            <ul>
              <li>By email: AI.Solution@lgcns.com</li>
            </ul>
          </div>
        </vuescroll>
      </div>
...
export default {
  data: function () {
    return {
      ...
      pageDescription: 'AI Service portal follos privacy policy.',
      tdates: [
        { text: '1/12/2020', value: '20201201' }
      ]
    }
  }
}
