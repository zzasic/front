    ...
    <vuescroll>
      ...
      <v-card class="data-grid-wrap default clickable" :style="'width: 97%; height: 100%'">
        <div class="db-card__chart">
          ...
          <pie-charts v-if="digitalUsageChart.length > 0"
  ...
  data () {
    return {
      ...
      headers: [
        ...
        { text: '버튼(건)', value: 'buttonCnt', align: 'center', width: '15%', sortable: false },
        { text: '침묵(건)', value: 'silenceCnt', al11ign: 'center', class: 'text-center', width: '15%', sortable: false },
    ...
    fnc_getTaskCategoryStatiaticsChart: function () {
      ...
      getTaskCategoryStatiaticsChart(searchCondition).then(
        response => {
          ...
          // console.log(' ==== ' + this.digitalUsageChart.length)
          ...
          if (this.digitalUsageChart.length > 0) {
            ...
            for (let i = 0; i < this.digitalUsageChart.length; i++) {
              ...
              console.log(this.digitalUsageChart[i].ratio)
            }
            this.digitalUsageChartColor = this.chartBgColor.splice(0, this.digitalUsageChart.length)
            ...
            console.log(this.pieChartJSData)
          }
        },
        error => {
          const status = error.data.status
