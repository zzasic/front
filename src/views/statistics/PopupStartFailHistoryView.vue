...
import { getInboundStartFailList } from '../../api/statistics'
export default {
  name: 'PopupStartFailHistoryView',
  props: {
    popup: Object
  },
  components: {
  ...
  methods: {
    init: async function () {
      await this.getInboundStartFailList()
    },
    // 이력 조회
    getInboundStartFailList: function () {
      // param setting
      ...
      getInboundStartFailList(searchCondition).then(
        response => {
          // 조회결과
