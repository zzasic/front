...
import { getScenarioSuccessList } from '../../api/statistics'
export default {
  name: 'PopupScenarioSuccessHistoryView',
  props: {
    popup: Object
  },
  components: {
  ...
  methods: {
    init: async function () {
      await this.getScenarioSuccessList()
    },
    // 이력 조회
    getScenarioSuccessList: function () {
      // param setting
      ...
      getScenarioSuccessList(searchCondition).then(
        response => {
          // 조회결과
