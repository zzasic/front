<template>
  <v-card class="dialog-systemInfo">
    <v-card-title>
    <span class="headline">시스템 등록</span>
    </v-card-title>
    <v-card-text>
      <v-form
        ref="form"
      ...
      <v-container>
        ...
        <v-row>
          ...
          <v-col cols="2"></v-col>
          <v-col cols="1">
            <span class="label must">ChatBot 사용</span>
          </v-col>
          <v-col cols="4">
            <v-radio-group
              class="default mt-1 pt-0"
        ...
        <v-row>
          ...
          <v-col cols="2"></v-col>
          <v-col cols="1">
            <span class="label must">TA 사용</span>
          </v-col>
          <v-col cols="4">
            <v-radio-group
              class="default mt-1 pt-0"
...
export default {
  ...
  name: 'PopupCreateSystemInfoView',
